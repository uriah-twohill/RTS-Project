...
public class EnemySkeletonSpawn : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameObject.GetComponent<UnitController>().getHealth() <= 0)
        {
            ...
            gameObject.GetComponent<NavMeshAgent>().SetDestination(new Vector3(GameObject.Find("rpgpp_lt_terrain_grass_01 (47)").transform.position.x + Random.Range(-10, 10), GameObject.Find("rpgpp_lt_terrain_grass_01 (47)").transform.position.y, GameObject.Find("rpgpp_lt_terrain_grass_01 (47)").transform.position.z + Random.Range(-10, 10)));
